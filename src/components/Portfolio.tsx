  ...
  return (
    ...
    >
      <div className="flex justify-center pt-5">
        <a
          href="#top"
          className="flex h-11 w-11 items-center justify-center rounded-lg shadow-sm transition-transform duration-200 hover:scale-105"
        >
          <img src={dark ? "/logo-white.png" : "/logo-gold.png"} alt="AE" className="h-11 w-11 object-contain" />
        </a>
      </div>
      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        <a href="#top" className="flex items-center gap-3 text-sm font-medium">
          <span className="flex h-9 w-9 items-center justify-center rounded-md">
            <img src={dark ? "/logo-white-sm.png" : "/logo-gold.png"} alt="AE" className="h-9 w-9 object-contain" />
          </span>
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-6 py-10 sm:flex-row sm:items-center">
        <div className="flex items-center gap-3 text-sm">
          <span className="relative flex h-9 w-9 items-center justify-center rounded-md">
            <img src="/logo-white-sm.png" alt="AE" className="absolute h-9 w-9 object-contain dark:block hidden" />
            <img src="/logo-gold.png" alt="AE" className="absolute h-9 w-9 object-contain block dark:hidden" />
          </span>
